    ...
    new Recipe(
      ...
      [
       // Apfelmus
        ...
        { id: "ing_cinnamon_stick", name: "Zimtstange",           amount: 0.5, unit: "Stk" }, // ½
        { id: "ing_apples",         name: "Äpfel",                amount: 800, unit: "g" },

        // Ghackets & Hörnli
        { id: "ing_beef_ground",          name: "gehacktes Rindfleisch", amount: 600, unit: "g" }, // 500–600 → 600
        { id: "ing_frying_fat",           name: "Bratbutter oder Bratcrème",               unit: "n. B." },
        { id: "ing_onion",                name: "Zwiebel",              amount: 1,   unit: "Stk" },
        { id: "ing_garlic_clove",         name: "Knoblauchzehe",        amount: 1,   unit: "Stk" },
        { id: "ing_marjoram_twigs",       name: "Majoranzweige",        amount: 3,   unit: "Zweig" },
        { id: "ing_thyme_twigs",          name: "Thymianzweige",        amount: 5,   unit: "Zweig" },
        { id: "ing_tomato_puree",         name: "Tomatenpüree",         amount: 1,   unit: "EL" },
        { id: "ing_flour",                name: "Mehl",                 amount: 1.5, unit: "EL" }, // 1½
        { id: "ing_redwine_or_bouillon",  name: "Rotwein oder Bouillon",amount: 1,   unit: "dl" },
        ...
        { id: "ing_cheese_grated",        name: "geriebener Käse",      amount: 100, unit: "g" },
        { id: "ing_marjoram_garnish",     name: "Majoran (zum Garnieren)",            unit: "n. B." },
]
    ), //
    new Recipe(
      2,
